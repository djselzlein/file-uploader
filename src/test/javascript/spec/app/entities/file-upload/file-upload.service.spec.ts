    ...
    describe('FileUpload Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/file-uploads';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FileUpload', () => {
                service.create(new FileUpload(null)).subscribe(received => {
            ...
            it('should update a FileUpload', () => {
                service.update(new FileUpload(123)).subscribe(received => {
